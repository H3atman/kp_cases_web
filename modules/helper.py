...
def store_data(newEntry, pi_distprov, pi_citymun, incident_selected_brgy, pi_street,dt_reported,time_reported_str,dt_committed,time_committed_str,vic_name,vic_fname,vic_midname,vic_lname,vic_qlfr,vic_alias,vic_age,vic_gndr,vic_distprov,vic_cityMun,vic_add_street, vic_address, sus_name, sus_address, offense_Type, offenseClass, det_narrative,case_status):
    ...
    cursor.execute("UPDATE crime_incidents SET province = %s, city = %s, barangay = %s, street = %s, date_reported = %s, time_reported = %s, date_committed = %s, time_commited = %s, offense = %s, offense_type = %s, victims_name_age_sex = %s, victims_local_address = %s, suspects_name_age_sex = %s, suspects_local_address = %s, narrative = %s, case_status = %s WHERE entry_number = %s", (pi_distprov, pi_citymun, incident_selected_brgy, pi_street, dt_reported, time_reported_str, dt_committed, time_committed_str, offense_Type, offenseClass,vic_name, vic_address, sus_name, sus_address, det_narrative, case_status, newEntry))

    # Enter data to the victim_details db
    cursor.execute("UPDATE victim_details (province, city, barangay, street, date_reported, time_reported, date_committed, time_commited, offense, offense_type, victims_name_age_sex, victims_local_address, suspects_name_age_sex, suspects_local_address, narrative, case_status, victim_first_name, victim_middle_name, victim_last_name, victim_qualifier, victim_alias, victim_age, victim_sex, victim_province_address,victim_city_address, victim_street_house_number_address) WHERE entry_number = %s", (pi_distprov, pi_citymun, incident_selected_brgy, pi_street, dt_reported, time_reported_str, dt_committed, time_committed_str, offense_Type, offenseClass,vic_name, vic_address, sus_name, sus_address, det_narrative, case_status,vic_fname,vic_midname,vic_lname,vic_qlfr, vic_alias, vic_age, vic_gndr, vic_distprov, vic_cityMun,vic_add_street,newEntry))
